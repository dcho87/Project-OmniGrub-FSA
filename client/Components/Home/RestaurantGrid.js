          ...
          <List>
            <ListItem className={classes.slidePanelDetails} spacing={1}>
              ...
              <Typography className={classes.ratingTextSide}>
                ...
                <Rating
                  name="read-only"
                  value={totalRests[isDrawerOpen.currentIdx]?.oRating}
                  precision={0.1}
                  readOnly
                />
              </Typography>
              ...
              <Typography className={classes.ratingTextSide}>
                ...
                <Rating
                  name="read-only"
                  value={totalRests[isDrawerOpen.currentIdx]?.yRating}
                  precision={0.1}
                  readOnly
                />
                <span>&nbsp;</span>
              ...
              {totalRests[isDrawerOpen.currentIdx]?.gRating !== 0 ? (
                <Typography className={classes.ratingTextSide}>
                  ...
                  <Rating
                    name="read-only"
                    value={totalRests[isDrawerOpen.currentIdx]?.gRating}
                    precision={0.1}
                    readOnly
                  />
              ...
              {totalRests[isDrawerOpen.currentIdx]?.fRating !== 0 ? (
                <Typography className={classes.ratingTextSide}>
                  ...
                  <Rating
                    name="read-only"
                    value={totalRests[isDrawerOpen.currentIdx]?.fRating}
                    precision={0.1}
                    readOnly
                  />
                  <span>&nbsp;</span>
